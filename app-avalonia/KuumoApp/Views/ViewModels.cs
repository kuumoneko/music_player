...
public record CollectionNav(string Title, MediaCard[] Cards, string SourceKey = "", Func<System.Threading.Tasks.Task<MediaCard[]>>? Reload = null);
...
public record TrackRow
{
    ...
    public TrackDto? Payload { get; init; }
