...
import { Downloader_options, Audio_format, download_mode, Download_queue, Status, Track, Search, User, Playlist, Album, Mode } from "./music/types.ts";
...
export default class Downloader {
    ...
    // search_youtube_video(arg0: string) {
    ...
    // async search(link: string, where?: string): Promise<Search> {
    //     return await this.music.search(link, where);
    // }

    // async spotifyuser(id: string): Promise<User> {
    //     return await this.music.spotify.fetch_spotify_user(id);
    // }

    // async youtubeuser(id: string): Promise<any> {
    //     return await this.music.youtube.fetch_youtube_user(id);
    // }

    // async refreshSpotifyToken(id: string): Promise<any> {
    //     return await this.music.spotify.refreshSpotifyToken(id);
    // }

    // async verifySpotifyToken(id: string): Promise<any> {
    //     return await this.music.spotify.verifySpotifyToken(id);
    // }

    // async spotify_liked_song(token: string): Promise<Playlist> {
    //     return await this.music.spotify.fetch_spotify_user_saved_playlists(token);
    // }

    // async youtube_liked_song(token: string): Promise<any> {
    //     return await this.music.youtube.fetchLikedVideos(token);
    // }

    // async spotify_user_playlists(id: string, token: string): Promise<any> {
    //     return await this.music.spotify.fetch_spotify_user_playlists(id, token);
    // }

    // async youtube_user_playlists(token: string): Promise<any> {
    //     return await this.music.youtube.fetch_youtube_user_playlist(token);
    // }

    // async verifyyoutubeuser(token: string): Promise<any> {
    //     return await this.music.youtube.gettoken(token);
    // }

    // async refreshYoutubeToken(id: string): Promise<any> {
    //     return await this.music.youtube.refreshYoutubeToken(id);
    // }


    // async youtube_playlist(id: string, token: string): Promise<any> {
    //     return await this.music.youtube.fetchPlaylistVideos(id, token);
    // }

    // async spotify_playlist(id: string, token: string): Promise<Playlist> {
    //     return await this.music.spotify.fetchPlaylistVideos_spotify(id, token);
    // }


    // async youtube_track(id: string): Promise<any> {
    //     return await this.music.youtube.fetchVideos(id);
    // }

    // async spotify_track(id: string): Promise<Track> {
    //     return await this.music.spotify.fetchTrackVideos_spotify(id);
    // }

    // async spotify_album(id: string): Promise<Album> {
    //     return await this.music.spotify.fetchAlbumVideos_spotify(id);
    // }

    // async findMatchingVideo(id: string) {
    //     const track: Track = await this.music.spotify.fetchTrackVideos_spotify(id);
    //     return await this.music.youtube.findMatchingVideo(track)
    // }
