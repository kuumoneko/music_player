...
export default function Download_Queue() {
    ...
    useEffect(() => {
        async function run() {
            ...
            await fetch_profile("write", LocalStorageKeys.download, hehe);
    ...
    return (
        <>
            <div
                onClick={async () => {
                    await fetch_profile("write", LocalStorageKeys.download, []);
                }}
            >
                        ...
                        return (
                            ...
                            >
                                ...
                                {mode === "track" ? (
                                    <div
                                        key={`download`}
                                        className={`vid flex h-[100px] w-[100%] flex-row items-center justify-between mb-[20px] bg-slate-700 hover:bg-slate-600`}
                                    >
                ...
                (item: any, index: number) => {
                    return (
                        <div
                            ...
                            className={`vid ${
                                index + 1
                            } flex h-[200px] w-[100%] flex-row items-center justify-between mb-[20px] bg-slate-700 hover:bg-slate-600`}
                        >
                            <div className="flex flex-row items-center">
                                <span className="thumbnail cursor-default select-none ml-[10px]">
                                    <img
